...
export class AnalyticsController {
  ...
  @ApiResponse({ status: 200, description: "Successfully fetched dashboard statistics" })
  @Get("dashboard")
  ...
  @ApiResponse({ status: 200, description: "Successfully fetched trend line data" })
  @Get("trends")
  @HttpCode(HttpStatus.OK)
  async getTrends(
  ...
  @ApiOperation({ summary: "Fetch projected carbon score trends based on active simulations" })
  @ApiResponse({ status: 200, description: "Successfully fetched projected timelines" })
  @Get("projections")
  @HttpCode(HttpStatus.OK)
