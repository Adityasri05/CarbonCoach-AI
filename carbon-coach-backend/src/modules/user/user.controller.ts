...
export class UserController {
  ...
  @ApiOperation({ summary: "Update user profile metadata and onboarding habits" })
  ...
  async updateProfile(
    ...
    @Body()
    body: {
      profile?: { name?: string; age?: number; country?: string; occupation?: string; avatarUrl?: string };
      habits?: {
    ...
    return this.userService.updateProfile(req.user.id, body.profile || {}, body.habits);
  }
}
