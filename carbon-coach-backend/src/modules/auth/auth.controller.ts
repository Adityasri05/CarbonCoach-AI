...
export class AuthController {
  ...
  @ApiResponse({ status: 200, description: "Login success, returns access & refresh tokens" })
  ...
  @ApiOperation({ summary: "Authenticate / Exchange Google OAuth access credentials" })
  @ApiResponse({ status: 200, description: "Google registration/login success" })
  @Post("google")
  @HttpCode(HttpStatus.OK)
  async googleLogin(
